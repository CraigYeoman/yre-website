      ...
      <div className="row flex-lg-row-reverse align-items-center g-5 p-4">
        <div className="col-lg-6">
          ...
          <p className="lead text-secondary">
            Founded on a heritage deeply rooted in racing, our legacy began with
            Jerry Yeoman's innate passion for modifying engines. From dominating
            ...
            years. Let us propel your racing program to new heights, delivering
            reliable horsepower and the guidance needed to triumph in the
            winners' circle.
          </p>
